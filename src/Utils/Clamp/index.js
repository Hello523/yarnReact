    ...
    function clamp(element, options) {
        ...
        var self = this,
            win = window,
           	 ...
           	 * [opt参数]
           	 * @clamp 			{num}     	行数
           	 * @useNativeClamp  {Object}    是否使用-webkit-line-clamp属性
           	 * @splitOnChars    {Object}	省略的符号（不限于省略号）的样式
           	 * @animate 		{Object}	是否实现动画折叠。
           	 * @truncationChar  {Object}    省略显示字符 默认 "..."
           	 * @truncationHTML  {Object}	省略的内容（不限于符号）
           	 */
            opt = {
